...
class OutputAccounts(BaseModel):
    """
    OutputAccounts
    """ # noqa: E501
    var_schema: Optional[StrictStr] = Field(default=None, description="A URL to the JSON Schema for this object.", alias="$schema")
    accounts: List[StrictStr] = Field(description="An array of addresses owned by the client", alias="Accounts")
    __properties: ClassVar[List[str]] = ["$schema", "Accounts"]
