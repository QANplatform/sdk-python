...
class OutputNewPendingTransactionFilter(BaseModel):
    """
    ...
    filter_id: StrictStr = Field(description="A filter id to be used when calling eth_getFilterChanges", alias="FilterId")
    __properties: ClassVar[List[str]] = ["$schema", "FilterId"]
