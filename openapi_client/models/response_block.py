...
class ResponseBlock(BaseModel):
    ...
    transactions: List[ResponseTransaction] = Field(description="An array of transaction objects - please see eth_getTransactionByHash for exact shape", alias="Transactions")
