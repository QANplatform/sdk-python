...
class OutputGetUncleCountByBlockNumber(BaseModel):
    """
    ...
    uncle_count: StrictStr = Field(alias="UncleCount")
    __properties: ClassVar[List[str]] = ["$schema", "UncleCount"]
