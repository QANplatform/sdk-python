...
class OutputGetFilterLogs(BaseModel):
    """
    OutputGetFilterLogs
    """ # noqa: E501
    var_schema: Optional[StrictStr] = Field(default=None, description="A URL to the JSON Schema for this object.", alias="$schema")
    logs: List[ResponseLog] = Field(description="An array of log objects, or an empty array if nothing has changed since last poll", alias="Logs")
    __properties: ClassVar[List[str]] = ["$schema", "Logs"]
