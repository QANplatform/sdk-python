...
class OutputBlobBaseFee(BaseModel):
    """
    OutputBlobBaseFee
    """ # noqa: E501
    var_schema: Optional[StrictStr] = Field(default=None, description="A URL to the JSON Schema for this object.", alias="$schema")
    base_fee: StrictStr = Field(description="The expected base fee in wei, represented in decimal format", alias="BaseFee")
    __properties: ClassVar[List[str]] = ["$schema", "BaseFee"]
