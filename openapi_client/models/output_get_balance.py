...
class OutputGetBalance(BaseModel):
    """
    OutputGetBalance
    """ # noqa: E501
    var_schema: Optional[StrictStr] = Field(default=None, description="A URL to the JSON Schema for this object.", alias="$schema")
    balance: StrictStr = Field(description="The ETH balance of the specified address in decimal value, measured in wei", alias="Balance")
    __properties: ClassVar[List[str]] = ["$schema", "Balance"]
