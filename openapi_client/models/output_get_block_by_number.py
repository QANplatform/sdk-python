...
class OutputGetBlockByNumber(BaseModel):
    """
    ...
    block: ResponseBlock = Field(description="A block object, or null when no block was found", alias="Block")
    __properties: ClassVar[List[str]] = ["$schema", "Block"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "Block": ResponseBlock.from_dict(obj["Block"]) if obj.get("Block") is not None else None
        })
        return _obj
