...
class OutputUnsubscribe(BaseModel):
    """
    OutputUnsubscribe
    """ # noqa: E501
    var_schema: Optional[StrictStr] = Field(default=None, description="A URL to the JSON Schema for this object.", alias="$schema")
    result: StrictBool = Field(description="A boolean value indicating if the subscription was canceled successfully", alias="Result")
