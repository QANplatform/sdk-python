...
class OutputGetTransactionByBlockNumberAndIndex(BaseModel):
    """
    ...
    transaction: ResponseTransaction = Field(description="The transaction response object, or null if no transaction is found", alias="Transaction")
    __properties: ClassVar[List[str]] = ["$schema", "Transaction"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "Transaction": ResponseTransaction.from_dict(obj["Transaction"]) if obj.get("Transaction") is not None else None
        })
        return _obj
