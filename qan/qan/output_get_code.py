...
class OutputGetCode(BaseModel):
    """
    OutputGetCode
    """ # noqa: E501
    var_schema: Optional[StrictStr] = Field(default=None, description="A URL to the JSON Schema for this object.", alias="$schema")
    bytecode: StrictStr = Field(description="The bytecode from a given address", alias="Bytecode")
    __properties: ClassVar[List[str]] = ["$schema", "Bytecode"]
