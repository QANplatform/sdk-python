...
class OutputChainId(BaseModel):
    """
    OutputChainId
    """ # noqa: E501
    var_schema: Optional[StrictStr] = Field(default=None, description="A URL to the JSON Schema for this object.", alias="$schema")
    chain_id: StrictStr = Field(description="A decimal value in string format which represents an integer of the chain ID", alias="ChainId")
    __properties: ClassVar[List[str]] = ["$schema", "ChainId"]
