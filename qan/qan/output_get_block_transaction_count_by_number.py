...
class OutputGetBlockTransactionCountByNumber(BaseModel):
    """
    ...
    transaction_count: StrictStr = Field(description="The number of transactions associated with a specific block, in decimal value", alias="TransactionCount")
    __properties: ClassVar[List[str]] = ["$schema", "TransactionCount"]
