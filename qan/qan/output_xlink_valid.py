...
class OutputXlinkValid(BaseModel):
    """
    OutputXlinkValid
    """ # noqa: E501
    var_schema: Optional[StrictStr] = Field(default=None, description="A URL to the JSON Schema for this object.", alias="$schema")
    validity: StrictStr = Field(description="The xlink validity time of the specified address.", alias="Validity")
    __properties: ClassVar[List[str]] = ["$schema", "Validity"]
