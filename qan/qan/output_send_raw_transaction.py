...
class OutputSendRawTransaction(BaseModel):
    """
    ...
    transaction_hash: StrictStr = Field(description="The transaction hash, or the zero hash if the transaction is not yet available", alias="TransactionHash")
    __properties: ClassVar[List[str]] = ["$schema", "TransactionHash"]
