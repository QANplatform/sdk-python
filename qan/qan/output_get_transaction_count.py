...
class OutputGetTransactionCount(BaseModel):
    """
    ...
    transaction_count: StrictStr = Field(description="The integer of the number of transactions sent from an address encoded as decimal", alias="TransactionCount")
