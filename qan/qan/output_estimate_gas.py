...
class OutputEstimateGas(BaseModel):
    """
    OutputEstimateGas
    """ # noqa: E501
    var_schema: Optional[StrictStr] = Field(default=None, description="A URL to the JSON Schema for this object.", alias="$schema")
    estimated_gas: StrictStr = Field(description="The estimated amount of gas used", alias="EstimatedGas")
    __properties: ClassVar[List[str]] = ["$schema", "EstimatedGas"]
