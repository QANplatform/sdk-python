...
class InputSendRawTransaction(BaseModel):
    """
    ...
    data: StrictStr = Field(description="The signed transaction (typically signed with a library, using your private key)", alias="Data")
    __properties: ClassVar[List[str]] = ["$schema", "Data"]
