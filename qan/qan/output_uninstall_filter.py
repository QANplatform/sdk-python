...
class OutputUninstallFilter(BaseModel):
    """
    ...
    result: StrictBool = Field(description="Returns true if the filter was successfully uninstalled, otherwise false", alias="Result")
    __properties: ClassVar[List[str]] = ["$schema", "Result"]
