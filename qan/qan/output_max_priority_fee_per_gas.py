...
class OutputMaxPriorityFeePerGas(BaseModel):
    """
    ...
    max_priority_fee_per_gas: StrictStr = Field(description="The hex value of the priority fee needed to be included in a block", alias="MaxPriorityFeePerGas")
    __properties: ClassVar[List[str]] = ["$schema", "MaxPriorityFeePerGas"]
