...
class OutputGasPrice(BaseModel):
    """
    OutputGasPrice
    """ # noqa: E501
    var_schema: Optional[StrictStr] = Field(default=None, description="A URL to the JSON Schema for this object.", alias="$schema")
    gas_price: StrictStr = Field(description="The decimal value of the current gas price in wei", alias="GasPrice")
    __properties: ClassVar[List[str]] = ["$schema", "GasPrice"]
