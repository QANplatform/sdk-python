...
class OutputBlockNumber(BaseModel):
    """
    OutputBlockNumber
    """ # noqa: E501
    var_schema: Optional[StrictStr] = Field(default=None, description="A URL to the JSON Schema for this object.", alias="$schema")
    block_number: StrictStr = Field(description="An integer value of the latest block number encoded as decimal", alias="BlockNumber")
    __properties: ClassVar[List[str]] = ["$schema", "BlockNumber"]
