...
**filter_id** | **str** | A filter id to be used when calling eth_getFilterChanges | 
...
output_new_pending_transaction_filter_form_dict = output_new_pending_transaction_filter.from_dict(output_new_pending_transaction_filter_dict)
```
