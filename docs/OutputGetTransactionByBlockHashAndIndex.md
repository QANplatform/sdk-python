...
output_get_transaction_by_block_hash_and_index_form_dict = output_get_transaction_by_block_hash_and_index.from_dict(output_get_transaction_by_block_hash_and_index_dict)
```
