...
**amount** | **str** | The amount of ether, provided in decimal format, corresponding to a certain value in gwei | 
...
response_withdrawals_form_dict = response_withdrawals.from_dict(response_withdrawals_dict)
```
