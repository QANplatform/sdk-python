...
**transactions** | [**List[ResponseTransaction]**](ResponseTransaction.md) | An array of transaction objects - please see eth_getTransactionByHash for exact shape | 
...
response_block_form_dict = response_block.from_dict(response_block_dict)
```
